...
export default function AccessPage() {
    ...
    return (
        <main className="h-screen flex flex-col md:flex-row bg-[#F2F2F2]">
            ...
            <div className="flex flex-col justify-start md:justify-center items-center bg-gradient-to-br from-[#F2A20C] to-[#F28B0C] text-white p-12 max-md:pb-0 max-md:h-2/3 md:w-1/2">
                ...
                <div className="max-w-sm text-center space-y-3">
                    ...
                    <p className="hidden md:flex text-lg text-white/90">
                        Gerencie o cardápio do seu bar de forma simples,
                        rápida e moderna.
                    </p>
