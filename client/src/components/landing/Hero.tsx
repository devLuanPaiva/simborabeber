  ...
  return (
    <section className="w-full flex flex-col md:flex-row items-center justify-between gap-10 pt-10">
      <div className="flex-1 text-left">
        ...
        >
          Gestão inteligente para <span className="text-[#F28B0C]">bares</span>{" "}
          com <span className="text-[#F2A20C]">cardápio digital</span>
        </motion.h1>
        ...
        >
          Controle comandas, produtos e vendas de forma simples e rápida. Um
          sistema feito para não atrapalhar a correria do seu bar.
        </motion.p>
        ...
        >
          <button
            ...
            className="bg-[#F2A20C] text-white px-6 py-3 rounded-xl font-semibold hover:bg-[#F28B0C] transition w-full md:w-fit text-center cursor-pointer"
          >
            Falar conosco
          </button>
