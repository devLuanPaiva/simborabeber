"use client";
import { adminMenuItems, IMenuItems, managerMenuItems, waiterMenuItems } from "@/data/constants";
...
export function Sidebar({
    ...
    const [themeColor, setThemeColor] = useState<"text-secondary" | "text-primary">("text-secondary");
