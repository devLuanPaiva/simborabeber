...
export const LoaderFour = ({ text = "Loading..." }: { text?: string }) => {
    return (
        <div className="relative font-bold text-white [perspective:1000px] dark:text-white">
            <motion.span
                animate={{
...
export const LoaderFive = ({ text }: { text: string }) => {
    return (
        <div className="font-sans text-white font-bold [--shadow-color:var(--color-neutral-500)] dark:[--shadow-color:var(--color-neutral-100)]">
